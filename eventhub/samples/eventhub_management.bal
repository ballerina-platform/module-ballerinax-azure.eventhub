...
public function main() {
    ...
    if (getEventHubResult is eventhub:EventHub) {
        log:printInfo(getEventHubResult.toString());
        log:printInfo("Successfully Get Event Hub!");
    } 

    // --------------------------------- Update Event Hub --------------------------------------------------
    eventhub:EventHubDescriptionToUpdate eventHubDescriptionToUpdate = {
    ...
    if (updateResult is eventhub:EventHub) {
    ...
    if (listResult is stream<eventhub:EventHub>) {
        _ = listResult.forEach(isolated function (eventhub:EventHub eventHub) {
